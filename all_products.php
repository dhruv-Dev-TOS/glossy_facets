    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content">
                    ...
                    <div class="col-12 col-sm-12 col-lg-12">
                        <div class="card">
                            <div class="card-header" style="justify-content: space-between;">
                                <h4>All Products</h4>
                                <div>
                                    <a href="add_new_blog.php" class="btn btn-icon btn-primary"><i class="fa fa-plus"></i>&nbsp;Add New Product</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table dataTable   table-bordered table-striped" data-filtering="true" data-sorting="true" data-paging="true" data-paging-size="15">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-breakpoints="">Images&nbsp;</th>
                                                <th data-breakpoints="">Attribute & Prices&nbsp;</th>
                                                <th data-breakpoints="">Active&nbsp;</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <td>' . $j . '</td>
                                                    <td>' . $row['name'] . '</td>
                                                    <td>' . $row['category'] . '</td>
                                                    <td><a class= "btn btn-primary">View Images</a></td>
                                                    <td><a class= "btn btn-primary">View Details</a></td>
                                                    <td>' . $row['is_active'] . '</td>
                                                    <td><a  class= "btn btn-primary">Edit</a><button onclick="javascript:delete_product(' . $row['id'] . ');" style="margin-left:5px;" class= "btn btn-danger">Delete</button></td>
                                                </tr>';
                                                $j++;
                                            }
                                            ?>
                ...
                if (isConfirm.value) {
                    window.location = 'api/delete_product.php?product_id=' + id;
                    swal.fire(
                        'Deleted!',
