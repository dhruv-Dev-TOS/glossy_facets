                                    ...
                                    <table  id="example" class="table dataTable   table-bordered table-striped" data-filtering="true" data-sorting="true" data-paging="true" data-paging-size="15">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-breakpoints="">Company Name&nbsp;</th>
                                                <th data-breakpoints="">Company Contact&nbsp;</th>
                                                <th data-breakpoints="">Company Email&nbsp;</th>
                                                <th data-breakpoints="">Subject&nbsp;</th>
                                                <th data-breakpoints="">Message&nbsp;</th>
                                                <th data-breakpoints="">Upload Date&nbsp;</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                               ...
                                               <td><button onclick="javascript:delete_enq('.$row['id'].')" class="btn btn-danger"  >Delete</button></td>
                                               </tr>';
                                               $j++;
                                            }
                                            ?>
                ...
                <script>
                    function delete_enq(id) {
                        swal.fire({
                            ...
                            if (isConfirm.value) {
                                window.location = 'api/delete_b2b_enq.php?enq_id=' + id;
                                swal.fire(
                                    'Deleted!',
