                                    ...
                                    <table id="example" class="table dataTable   table-bordered table-striped" data-filtering="true" data-sorting="true" data-paging="true" data-paging-size="15">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-breakpoints="">Email ID&nbsp;</th>
                                                <th data-breakpoints="">Subject&nbsp;</th>
                                                <th data-breakpoints="">Message&nbsp;</th>
                                                <th data-breakpoints="">Enquiry Date&nbsp;</th>
                ...
                <script>
                    function delete_enq(id) {
                        swal.fire({
                            ...
                            if (isConfirm.value) {
                                window.location = 'api/delete_contact_enquiry.php?enq_id=' + id;
                                swal.fire(
                                    'Deleted!',
