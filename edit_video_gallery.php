...
require_once 'db.php';
$sql = mysqli_query($link, 'SELECT * FROM video_gallery WHERE id = ' . $video_id . '');
                                ...
                                <form action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="" class="form-control" id="video_link" value="<?php echo $row['video']?>">
                                            </div>
                                        </div>
                                    ...
                                    <input style="display: none;" type="text" name="" id="video_id" value="<?php echo $video_id; ?>">
                                </form>
